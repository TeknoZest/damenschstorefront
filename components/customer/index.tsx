          ...
          <div className="flex-col w-full px-5 py-5 flex items-center justify-center">
            ...
            <div className="mt-10 flex sm:flex-col1">
              <button
                ...
                className="max-w-xs flex-1 bg-black uppercase border border-transparent rounded-sm py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-pink focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
              >

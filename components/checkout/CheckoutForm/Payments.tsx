      ...
      {methods?.map((item: any, idx: number) => {
        return (
          <li
            ...
            }  pointer border-t border py-5 px-5 flex justify-start flex-row hover:border-gray-400 cursor-pointer`}
          >
            ...
            <div>
              ...
              <p className="text-sm py-2 text-gray-400 font-normal">{item.description}</p>
            </div>
          </li>
        )
      })}

                    ...
                    <span className="relative">
                      {image.image ? (
                        <div className='image-container'>
                          <InnerImageZoom fadeDuration={300} 
              ...
              {updatedProduct ? (
                <>
                  <div className="sm:mt-8 mt-6 flex sm:flex-col1">
                    ...
                    <button
                      className="max-w-xs flex-1 ml-2 bg-gray-600 border border-transparent rounded-sm uppercase py-3 px-8 flex items-center justify-center font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-500 sm:w-full"
                    ...
                    <button
                      ...
                      className="ml-2 py-3 px-4 rounded-sm bg-white border border-gray-300 flex items-center justify-center text-gray-500 hover:bg-red-50 hover:text-pink sm:px-10 hover:border-pink"
                    >
                    {isInWishList ? (

      ...
      <div key={product.id} className="relative p-2 sm:p-3">          
        ...
        >
          <a href={currentProductData.link}>
            <div className="relative overflow-hidden bg-gray-200 aspect-w-1 aspect-h-1 hover:opacity-90">
                <Image
                  priority
        ...
        <div className="pt-4 mb-2 text-left">
          ...
          {hasColorVariation ? (
             <div className='border-b w-full mb-2 pb-1'>
              ...
              <div className='border-b border-white w-full mb-2 pb-1 w-full'><div className="sm:h-4 sm:w-4 h-1 w-1 sm:mr-2 mr-1 mt-2 inline-block" />  </div>
            )}
